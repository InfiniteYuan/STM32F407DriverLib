...
u16 W25QXX_TYPE = W25Q32;	//默认是W25Q16

//初始化SPI FLASH的IO口
W25QXX::W25QXX(SPI &SPIx, GPIO_TypeDef* CSPortx, u16 CSPinx) :mSPI(SPIx), mCSPort(CSPortx), mCSPin(CSPinx)
{
...
void W25QXX::W25QXX_Write_Page(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
	u16 i;
...
//CHECK OK
void W25QXX::W25QXX_Write_NoCheck(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
	u16 pageremain;
...
void W25QXX::W25QXX_Write(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
	u32 secpos;
	u16 secoff;
	u16 secremain;
