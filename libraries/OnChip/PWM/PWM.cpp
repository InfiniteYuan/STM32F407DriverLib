...
void PWM::Initialize(TIM_TypeDef *timx, bool enCh1, bool enCh2, bool enCh3, bool enCh4, u16 frq)
{
	...
	else if (_timx == TIM2)
	{
		...
		_pin3 = GPIO_Pin_2;
		_pin4 = GPIO_Pin_3;
		_GPIO_AF = GPIO_AF_TIM2;
		_GPIO_PinSource1 = GPIO_PinSource0;
		_GPIO_PinSource2 = GPIO_PinSource1;
		_GPIO_PinSource3 = GPIO_PinSource2;
		_GPIO_PinSource4 = GPIO_PinSource3;
	}
	else if (_timx == TIM3)
	{
		mTimeFre = 84;
		...
		_pin3 = GPIO_Pin_0;
		_pin4 = GPIO_Pin_1;
		_GPIO_AF = GPIO_AF_TIM3;
		_GPIO_PinSource1 = GPIO_PinSource6;
		_GPIO_PinSource2 = GPIO_PinSource7;
		_GPIO_PinSource3 = GPIO_PinSource0;
		_GPIO_PinSource4 = GPIO_PinSource1;
	}
	else if (_timx == TIM4)
	{
		mTimeFre = 84;
		...
		_pin3 = GPIO_Pin_8;
		_pin4 = GPIO_Pin_9;
		_GPIO_AF = GPIO_AF_TIM4;
		_GPIO_PinSource1 = GPIO_PinSource6;
		_GPIO_PinSource2 = GPIO_PinSource7;
		_GPIO_PinSource3 = GPIO_PinSource8;
		_GPIO_PinSource4 = GPIO_PinSource9;
	}
